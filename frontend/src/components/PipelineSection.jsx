const PIPELINE_STEPS = [
  {
    ...
    symbol: '⬡',
    title: 'Ingest',
    description: 'Upload a screenshot or paste a link so the system can normalize the claim source.',
    tech: 'Gemini Vision',
  },
  {
    number: '02',
  ...
  },
  {
    ...
    symbol: '⊕',
    title: 'Search',
    description: 'Pull the most relevant reporting around the claim from live external coverage.',
    tech: 'Tavily API',
  },
  {
    number: '04',
    symbol: '◈',
    title: 'Rank',
    description: 'Filter results to the most relevant sources and trim away noisy or promotional snippets.',
    tech: 'Custom scoring',
  },
  {
    number: '05',
